export const productsDB = [
  ...
  },
  {
    ...
    cate: 'gnss-x5',
    desc: 'Estación Base y Rover GNSS multibanda y multiconstelación. Trabaja en modos Estático, PPK, RTK, NTRIP y RTK Local para drones equipados con GNSS. Cuenta con compensación de inclinación IMU para levantamiento.',
    banner: '',
    bannerM: '',
    mainAdv: [
      {
        advItem: 'Calibrado por el National Geodetic Survey NGS (NOAA) con la antena METX5.'
      },
      {
        advItem: 'Guarda data cruda en archivos UBX con una memoria interna de 32 GB.'
      },
      {
        advItem: 'Transferencia de datos NMEA mediante Bluetooth con aplicaciones GIS como SurPad o SW Maps.'
      },
      {
        advItem: 'Duración de batería de aproximadamente 15 horas, con opción de conectar una batería externa.'
      },
      {
        advItem: 'Dispositivo robusto, con protección IP67, que lo protege contra polvo y agua.'
      },
      {
        advItem: 'Levantamiento de puntos con medición inclinada mediante aplicación FindX5.'
      },
    ],
    techSpecs: [
      {
        ...
        secondary: [
          { spec: 'Canales: 184' },
          { spec: 'Tiempo de inicialización: 5 segundos' },
          { spec: 'Tiempo para primer fix: 25s (frío), 2s (caliente)' },
          { spec: 'Frecuencia de registro: Hasta 10 Hz o 0.1 segundos' },
          { spec: 'Constelaciones: GPS (L1C/A - L2C), GLONASS (L1OF - L2OF), Galilleo (E1 B/C - ESb), Beiduo (B1l - B2l), QZSS (L1C/A - L2C), SBAS (L1C/Z)' },
          { spec: 'Precisión Estático: H=3.5mm + 1ppm, V=6mm + 1ppm' },
          { spec: 'Precisión PPK: H=6mm + 1ppm, V=10mm + 1ppm' },
          { spec: 'Precisión RTK: H=7mm + 1ppm, V=12mm + 1ppm' },
        ]
      },
      {
        primary: 'Medicioones inclinadas',
        secondary: [
          { spec: 'Precisión RTK: H=7mm + 1ppm + 25mm/15, V=12mm + 1ppm + 6mm/15, H=7mm + ppm + 3mm/25, V=12mm + 1ppm + 6mm/25' },
        ]
      },
      {
        primary: 'Conectividad',
        secondary: [
          { spec: 'Radio LoRa: Frecuencias disponibles 433 o 915MHz (elección), potencia 1W, Ganancia antena 5dBi,distancia 10km a línea de visión, distancia típica 2km con interferencia moderada a baja' },
          { spec: 'Wi-fi: 2.4Ghz 802.11n/g/n' },
          { spec: 'Bluetooth: 4.2 BR/EDR' },
          { spec: 'Puertos: USB-C, antena TNC' },
        ]
      },
      {
        primary: 'Data',
        secondary: [
          { spec: 'Protocolos: NTRIP, RTCM3' },
          { spec: 'Formato de archivos: UBX' },
          { spec: 'Salida de posición: NMEA, RAW data (para RINEX)' },
          { spec: 'Almacenamiento interno: Memoria de 32GB' },
        ]
      },
      {
        primary: 'Físico',
        secondary: [
          { spec: 'Dimensiones: 138 x 138 x 85mm' },
          { spec: 'Peso: 650 gramos' },
          { spec: 'Temperatura de funcionamiento: -20 a 65 C' },
          { spec: 'Diseño cerrado protección IP67: Capaz de proteger contra potentes chorros de agua' },
          { spec: 'El agua se proyecta en potentes chorros (boquilla de 12,5mm) contra el recinto desde cualquier dirección no tendrá efectos nocivos' },
      ...
      },
      {
        ...
        secondary: [
          { spec: 'Voltaje de entrada: 4.75 - 5.5 V' },
          { spec: 'Polarización de CC de la antena interna: 3.3 V' },
          { spec: 'Consumo máximo de corriente: 2500mA' },
          { spec: 'Consumo medio de corriente: 500mA' },
          { spec: 'Límite de corriente en USB OTG: 2000mA' },
          { spec: 'LiPo 64h con carga rápida de 1.5 A' },
          { spec: 'Más de 15 h de trabajo autónomo' },
        ]
      },
    ],
    includes: [],
