...
export const ContactView = () => {
  ...
  return (
    <ShopLayout
      pageTitle='Contacto'
      pageDesc='Contacta a Müpütun para cotizar receptores GNSS X5, RTK, PPK, NTRIP Local, CORS, SurPad y accesorios de precisión centimétrica en Chile.'
    >
          ...
          <div className='flex flex-col justify-between rounded-[2.5rem] bg-white/42 p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.72),0_28px_90px_rgba(15,23,42,0.12)] backdrop-blur-2xl lg:p-10'>
            <div>
              ...
              <p className='mt-6 max-w-xl text-lg leading-8 text-slate-600'>
                Cuéntanos si necesitas RTK, PPK, NTRIP Local, CORS, SurPad o integración con drones DJI, Autel, Wingtra y eBee. Te orientamos con una configuración aterrizada a tu trabajo.
              </p>
            </div>
            ...
            <div className='mt-12 space-y-3'>
              {[
                ...
                [IoLocationOutline, 'Chile', 'Soporte remoto y coordinación para proyectos locales'],
          ...
          >
            <div className='mb-8'>
              ...
              <p className='mt-3 text-sm leading-6 text-slate-600'>
                Indica zona de trabajo, precisión esperada, software y si usarás base, rover, CORS o drone RTK.
              </p>
            </div>
