...
export const BlogsView = ({ blogs }: BlogsViewProps) => {
  ...
  return (
    <ShopLayout
      pageTitle='Blogs'
      pageDesc='Artículos técnicos de Müpütun sobre GNSS, RTK, PPK, NTRIP, drones y precisión geoespacial.'
    >
        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          <div className='mx-auto max-w-4xl text-center'>
            ...
            <h1 className='mt-5 text-5xl font-semibold tracking-normal text-slate-950 sm:text-6xl lg:text-7xl'>
              Ideas para medir mejor.
            </h1>
            <p className='mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600'>
              Lecturas claras sobre GNSS, drones RTK, calibración, canales y decisiones técnicas para proyectos geoespaciales.
            </p>
          </div>
        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          <div className='mb-12 max-w-3xl'>
            ...
            <h2 className='mt-4 text-4xl font-semibold tracking-normal text-slate-950 sm:text-5xl'>
              Más lecturas con profundidad técnica.
            </h2>
            <p className='mt-5 text-lg leading-8 text-slate-600'>
              Casos, criterios y decisiones de campo presentadas en un formato más visual para recorrer rápido y entrar al detalle cuando lo necesites.
            </p>
          </div>
